...
func (m *AdminAllReply) validate(all bool) error {
	...
	// no validation rules for AllWithdrawMonth
...
// Validate checks the field values on UpdateUserRequest_SendBody with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateUserRequest_SendBody) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateUserRequest_SendBody with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateUserRequest_SendBodyMultiError, or nil if none found.
func (m *UpdateUserRequest_SendBody) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateUserRequest_SendBody) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateUserRequest_SendBodyMultiError(errors)
	}

	return nil
}

// UpdateUserRequest_SendBodyMultiError is an error wrapping multiple
// validation errors returned by UpdateUserRequest_SendBody.ValidateAll() if
// the designated constraints aren't met.
type UpdateUserRequest_SendBodyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateUserRequest_SendBodyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateUserRequest_SendBodyMultiError) AllErrors() []error { return m }

// UpdateUserRequest_SendBodyValidationError is the validation error returned
// by UpdateUserRequest_SendBody.Validate if the designated constraints aren't met.
type UpdateUserRequest_SendBodyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateUserRequest_SendBodyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateUserRequest_SendBodyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateUserRequest_SendBodyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateUserRequest_SendBodyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateUserRequest_SendBodyValidationError) ErrorName() string {
	return "UpdateUserRequest_SendBodyValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateUserRequest_SendBodyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateUserRequest_SendBody.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateUserRequest_SendBodyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateUserRequest_SendBodyValidationError{}
